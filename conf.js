...
c.mongo.connectionString = process.env.MONGODB_CONN || null
...
c.poloniex = {}
c.poloniex.key = process.env.POLONIEX_KEY || 'YOUR-API-KEY'
c.poloniex.secret = process.env.POLONIEX_SECRET || 'YOUR-SECRET'
